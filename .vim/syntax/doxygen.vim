...
" Last Change:  23 November 2006
" Version:      1.15 modified
"
    ...
    if exists('g:doxygen_codeword_font')
      ...
      if has('gui_running')
        ...
        elseif has('gui_win32') || has('gui_win16') || has('gui_win95')
          " Lucida Console is the most universally available monospaced
          " font for our purpose, but it has the obvious problem of not
          " aligning well with other fonts like Courier New.  If you
          " had Andale Mono or Lucida Sans Typewriter installed, you
          " may use them: just replace the following two instances of
          " 'Bitstream_Vera_Sans_Mono' with 'Andale_Mono' etc.
          " Otherwise Bitstream Vera Sans Mono is a good choice, and it
          " is freely available at
          " <URL:http://ftp.gnome.org/pub/GNOME/sources/ttf-bitstream-vera/1.10/>.
          if &guifont == ''
            let font='font=Bitstream_Vera_Sans_Mono:h10'
          else
            let font='font='.substitute(&guifont, '^[^:]*', 'Bitstream_Vera_Sans_Mono','')
          endif
